...
Future development has been directed to the [idrsolutions client](https://github.com/idrsolutions/idrsolutions-php-client), which can be used for the same purpose. This package will receive no more updates. 
