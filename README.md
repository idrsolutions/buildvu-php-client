...
IDR Solutions offer a free trial service for running BuildVu with PHP, more infomation on this can be found [here]. (https://www.idrsolutions.com/buildvu/convert-pdf-in-php/)
